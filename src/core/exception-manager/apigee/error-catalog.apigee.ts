const ErrorCatalogApigee: any = {
  ...
  20039: {
    ...
    en: {
      developerMessage:
        'Invalid {0} parameter {1} - it must be filled with a valid bank account number, including a separator and digit',
      userMessage:
        'Invalid field {1} - it must be filled with a valid bank account number, including a separator and digit',
    },
    'pt-BR': {
      developerMessage:
        'Parâmetro {1} inválido {0} - o valor deve ser um número de conta bancária, incluindo separador e dígito',
  ...
  20054: {
    ...
    en: {
      developerMessage:
        'Invalid query parameters - specify period_greater and period_lesser or salesordernumber_greater',
  ...
  20055: {
    ...
    en: {
      developerMessage:
        'Invalid query parameters period_greater and period_lesser - the interval between dates is greater than 7 days',
      userMessage:
        'Invalid fields period_greater and period_lesser - the interval between dates is greater than 7 days',
    },
    'pt-BR': {
      developerMessage:
        'Query params inválidos pediod_greater e period_lesser - o intervalo entre datas deve é maior que 7 dias',
  ...
  20056: {
    ...
    en: {
      developerMessage:
        'Invalid query parameter salesordernumber_lesser - the date of this order is lesser than 7 days',
  ...
  20086: {
    ...
    en: {
      developerMessage:
        'Invalid {0} parameter {1} - it must be filled with a slug (are three characters where the first is a letter and the other two can be numbers and letters)',
      userMessage:
        'Invalid field {1} - it must be filled with a slug (are three characters where the first is a letter and the other two can be numbers and letters)',
    },
    'pt-BR': {
      developerMessage:
        'Parâmetro {1} inválido {0} - o valor deve ser um slug (3 caracteres onde o primeiro é uma letra e os demais podem ser números e letras)',
      userMessage:
        'Campo {1} inválido {0} - o valor deve ser um slug (3 caracteres onde o primeiro é uma letra e os demais podem ser números e letras)',
    },
  },
  20087: {
    httpcode: 400,
  ...
  20092: {
    ...
    en: {
      ...
      userMessage:
        'You attempted to verify the exchange eligibility for a {0}, but the eligibility is not available for this {0}',
    },
    'pt-BR': {
      developerMessage: '{0} não está elegível para troca/cancelamento',
      userMessage:
        'Você tentou verificar a eligibilidade para troca/cancelamento de {0}, mas o mesmo não está mais elegível.',
    },
  },
  20093: {
    httpcode: 400,
    ...
    'pt-BR': {
      developerMessage:
        'Não foi possível mudar o status de tracking para o pedido - o mesmo já alcançou o {0} limite de eventos',
      userMessage:
        'Não foi possível mudar o status de tracking para o pedido - o mesmo já alcançou o {0} limite de eventos',
    },
  },
  20094: {
    ...
    en: {
      developerMessage:
        'Unable to save. It has already a {0} in this branch with same range and transport_type, with some of these route ids or branch ids. {1}',
      userMessage:
        'Unable to save. It has already a {0} in this branch with same range and transport_type, with some of these route ids or branch ids. {1}',
    },
    'pt-BR': {
      developerMessage:
        'Não foi possível salvar. Já existem registros de {0} nesta filial com a mesma operação e rotas ou filiais. {1}',
      userMessage:
        'Não foi possível salvar. Já existem registros de {0} nesta filial com a mesma operação e rotas ou filiais. {1}',
    },
  },
  ...
  20102: {
    ...
    en: {
      ...
      userMessage:
        'You attempted to verify the eligibility for a {0}, but the eligibility is not available for this {0}',
    },
  },
  20103: {
    httpcode: 412,
...
export default ErrorCatalogApigee;
